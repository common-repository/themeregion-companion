...
if ( !function_exists( 'trc_breadcrumbs' ) ) {
	function trc_breadcrumbs() {
		/* === OPTIONS === */
		$text['home']     = get_bloginfo(); // text for the 'Home' link
		...
		$before         = '<li class="breadcrumb-item breadcrumbs__current">'; // tag before the current crumb
